...
public class BigInt implements Cloneable {
  ...
  public int getDigitCount() {
    int fullChunksDigits = (chunks.size() - 1) * CHUNK_DIGITS;
    int largestChunkDigits = String.valueOf(chunks.get(chunks.size() - 1)).length();
    return fullChunksDigits + largestChunkDigits;
  }
